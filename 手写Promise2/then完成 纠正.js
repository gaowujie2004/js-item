  ...
  */
  try {
    ...
    if (x instanceof Promise) {
      ...
      // resolve， reject 是 promise2 的回调函数，
      // 在 x.then()  内部会这样调用：setTimeout(() =>{  resolve(x.data)   })
      return
    }
...
Promise.reject(-1111).then(val => console.log(val)).catch(err => console.log(err))
